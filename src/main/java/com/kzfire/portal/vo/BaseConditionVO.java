...
public class BaseConditionVO {
	...
	/**
	 * 分页操作方向 取值分别有first,prev,next,last,""
	 */
	...
	public String toString() {
		return "BaseConditionVO [numPerPage=" + numPerPage
				+ ", pageFirstRecordID=" + pageFirstRecordID
				+ ", pageLastRecordID=" + pageLastRecordID + ", pageNum="
				+ pageNum + ", totalCount=" + totalCount + ", direction="
				+ direction + ", offset=" + getOffset() + "]";
	}

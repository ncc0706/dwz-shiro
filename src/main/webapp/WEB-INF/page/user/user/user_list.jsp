	...
	<form onsubmit="return navTabSearch(this);" id="searchForm" action="user/user/list.do" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>员工姓名：<input type="text"  value="${vo.text1 }" name="text1" /></td>
					<td>员工账号：<input type="text" value="${vo.text2 }" name="text2" /></td>
					<td>
...
<div class="pageContent j-resizeGrid">
	<div class="panelBar" >
		<ul  class="toolBar" id="toolBar">
			...
			<li> 
				<a rel="addRole"  target="navTab" class="add" href="user/user/add.do" ><span>入职</span></a>
			</li>
			</shiro:hasPermission>
			<li>
			<a class="delete"
